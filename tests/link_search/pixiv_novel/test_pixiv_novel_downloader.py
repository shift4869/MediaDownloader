...
from media_downloader.link_search.pixiv_novel.pixiv_novel_downloader import DownloadResult, PixivNovelDownloader
...
logger = getLogger("media_downloader.link_search.pixiv_novel.pixiv_novel_downloader")
