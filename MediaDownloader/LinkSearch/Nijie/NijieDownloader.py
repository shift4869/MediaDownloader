...
from MediaDownloader.LinkSearch.Nijie.NijiePageInfo import NijiePageInfo
from MediaDownloader.LinkSearch.Nijie.NijieSaveDirectoryPath import NijieSaveDirectoryPath
