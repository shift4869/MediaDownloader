...
from MediaDownloader.LinkSearch.PixivNovel.PixivNovelDownloader import PixivNovelDownloader
from MediaDownloader.LinkSearch.PixivNovel.PixivNovelSaveDirectoryPath import PixivNovelSaveDirectoryPath
