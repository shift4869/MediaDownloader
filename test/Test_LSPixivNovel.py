...
from MediaDownloader import LSPixivNovel
...
class TestLSPixivNovel(unittest.TestCase):
    ...
    def __MakeLoginMock(self, mock: MagicMock) -> MagicMock:
        ...
        Note:
            ID/PWが一致すればOKとする
            対象のmockは "MediaDownloader.LSPixivNovel.LSPixivNovel.Login" にpatchする
    ...
    def test_LSPixivNovel(self):
        ...
        with ExitStack() as stack:
            mockpalogin = stack.enter_context(patch("MediaDownloader.LSPixivNovel.LSPixivNovel.Login"))
    ...
    def test_Login(self):
        ...
        with ExitStack() as stack:
            ...
            # mockpalogin = stack.enter_context(patch("MediaDownloader.LSPixivNovel.LSPixivNovel.Login"))
            mockpaapp = stack.enter_context(patch("MediaDownloader.LSPixivNovel.AppPixivAPI"))
