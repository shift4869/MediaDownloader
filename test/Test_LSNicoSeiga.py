...
from MediaDownloader import LSNicoSeiga
...
class TestLSNicoSeiga(unittest.TestCase):
    ...
    def __MakeLoginMock(self, mock: MagicMock) -> MagicMock:
        ...
        Note:
            ID/PWが一致すればOKとする
            対象のmockは "MediaDownloader.LSNicoSeiga.LSNicoSeiga.Login" にpatchする
    ...
    def test_LSNicoSeiga(self):
        ...
        with ExitStack() as stack:
            mocknslogin = stack.enter_context(patch("MediaDownloader.LSNicoSeiga.LSNicoSeiga.Login"))
    ...
    def test_Login(self):
        ...
        with ExitStack() as stack:
            # モック置き換え
            mocksession = stack.enter_context(patch("MediaDownloader.LSNicoSeiga.requests.session"))
    ...
    def test_Process(self):
        ...
        with ExitStack() as stack:
            ...
            mocknsdl = stack.enter_context(patch("MediaDownloader.LSNicoSeiga.LSNicoSeiga.DownloadIllusts"))
